        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentFee = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DateofBitrh = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Gender = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AppointmentFee = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    DoctorSenderId = table.Column<int>(type: "int", nullable: true),
                    PatientSenderId = table.Column<int>(type: "int", nullable: true),
                    DoctorReceiverId = table.Column<int>(type: "int", nullable: true),
                    PatientReceiverId = table.Column<int>(type: "int", nullable: true),
                    Message = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Timestamp = table.Column<DateTime>(type: "datetime2", nullable: false),
                    IsRead = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ChatMessages_Doctors_DoctorReceiverId",
                        column: x => x.DoctorReceiverId,
                        principalTable: "Doctors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ChatMessages_Doctors_DoctorSenderId",
                        column: x => x.DoctorSenderId,
                        principalTable: "Doctors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ChatMessages_Patients_PatientReceiverId",
                        column: x => x.PatientReceiverId,
                        principalTable: "Patients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ChatMessages_Patients_PatientSenderId",
                        column: x => x.PatientSenderId,
                        principalTable: "Patients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChatMessages_DoctorReceiverId",
                table: "ChatMessages",
                column: "DoctorReceiverId");

            migrationBuilder.CreateIndex(
                name: "IX_ChatMessages_DoctorSenderId",
                table: "ChatMessages",
                column: "DoctorSenderId");

            migrationBuilder.CreateIndex(
                name: "IX_ChatMessages_PatientReceiverId",
                table: "ChatMessages",
                column: "PatientReceiverId");

            migrationBuilder.CreateIndex(
                name: "IX_ChatMessages_PatientSenderId",
                table: "ChatMessages",
                column: "PatientSenderId");
